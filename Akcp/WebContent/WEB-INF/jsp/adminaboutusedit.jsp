            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                                <form:form action="saveeditaboutusimg" modelAttribute="editaboutsimg" method="post" enctype="multipart/form-data">
                                <form:hidden path="about_id"/>
                                <div class="col-md-3">
                                <label>Upload Banner Image</label>
								</div>
                                <div class="col-md-3">
                                   
                                    <input type="file" name="aboutfile" id="fileUpload" onchange="Upload();" value="" accept=".jpg,.png,jpeg" placeholder="File input" required="">
                                </div>
                                <input type="hidden" name="delaboutfile" value="${editaboutsimg.about_image}">
            ...
            reader.onload = function (e) {
                ...
                image.onload = function () {
                    ...
                    if (height == 692 && width == 492) {
                    	...
                    	{
                    	 alert("Height and Width must be 492px X 692px.");
