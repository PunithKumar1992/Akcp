...
<section id="main-content">
  ...
  <div class="panel panel-default">
    ...
    <c:url var="edithomeaboutusimg" value="edithomeaboutusimg">
    <c:param name="homeabout_id" value="${homeaboutimg.homeabout_id}"></c:param>
	 ...
	 <tr>
            ...
            <td>
			<a class="example-image-link" href="img/about/home/${homeaboutimg.homeabout_image}" data-lightbox="example-set" >		
	<img src="img/about/home/${homeaboutimg.homeabout_image}" alt="" width="70%"/>
	</a>
	 
			</td>
			<td>
		  <a href="${edithomeaboutusimg}"><button type="button" class="btn btn-primary">Edit</button></a>
		  </td>
