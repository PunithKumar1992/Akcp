            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                                <form:form action="saveedithomeaboutusimg" modelAttribute="edithmaboutsimg" method="post" enctype="multipart/form-data">
                                <form:hidden path="homeabout_id"/>
                                <div class="col-md-3">
                                <label>Upload Home about us Image</label>
								</div>
                                <div class="col-md-3">
                                   
                                    <input type="file" name="homeaboutfile" id="fileUpload" onchange="Upload();" value="" accept=".jpg,.png,jpeg" placeholder="File input" required="">
                                </div>
                                <input type="hidden" name="delaboutfile" value="${edithmaboutsimg.homeabout_image}">
								
                                <div class="col-md-3">
                                    <input type="submit" class="btn btn-info" value="Change" style="margin-top:-2%" id="sub"  disabled="disabled"/>
                                </div>
                                </form:form>
                            </div>
                        </div>
            ...
            reader.onload = function (e) {
                ...
                image.onload = function () {
                    ...
                    if (height == 549 && width == 550) {
                    	...
                    	{
                    	 alert("Height and Width must be 550px X 549px.");
