...
<html>
<head>
<title>Akhanda Karnatak Cinema Parishat:: Settings</title>
  ...
  <div class="panel panel-default">
    ...
    <c:param name="admin_id" value="${adminlist.admin_id}"></c:param>
        ...
        <tr>
            ...
            <td><a href="${editadmin}"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;<a href="${admindelete}" onclick="return confirmActiondelete();"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
