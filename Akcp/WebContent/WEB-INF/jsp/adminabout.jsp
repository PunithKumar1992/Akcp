...
<section id="main-content">
  ...
  <div class="panel panel-default">
    ...
    <c:url var="editaboutusimg" value="editaboutusimg">
    <c:param name="about_id" value="${aboutusimg.about_id}"></c:param>
	 ...
	 <tr>
            ...
            <td>
			<a class="example-image-link" href="img/about/aboutus/${aboutusimg.about_image}" data-lightbox="example-set" >		
	<img src="img/about/aboutus/${aboutusimg.about_image}" alt="" width="70%"/>
	</a>
	 
			</td>
			<td>
		  <a href="${editaboutusimg}"><button type="button" class="btn btn-primary">Edit</button></a>
		  </td>
