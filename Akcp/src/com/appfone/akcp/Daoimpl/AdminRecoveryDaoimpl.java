...
import com.appfone.akcp.Dao.AdminRecoveryDao;
...
public class AdminRecoveryDaoimpl implements AdminRecoveryDao {
	...
	public int checkMailidtosend(String email) {
		...
		int flag=0;
		Query query =session.createQuery("from Akcpadminregesitration where admin_email=:mail");
...
Session session =factory.getCurrentSession();
		...
		String result = (String)session.createCriteria(Akcpadminregesitration.class)
